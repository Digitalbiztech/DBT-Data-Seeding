...
When performing the data import, the order is reversed to satisfy Referential Integrity. Parents must exist in the destination org _before_ the Child record references them.
