...
- Implementation:
  ...
  - Parser extracts FROM object, LIMIT value, handles case‑insensitive names and managed‑package namespaces (ns**MyObj**c ↔ MyObj\_\_c). If unmatched, shows an error tied to the picklist.
